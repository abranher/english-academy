...
-- CreateEnum
CREATE TYPE "EnrollmentOrderStatus" AS ENUM ('UNVERIFIED', 'NEEDS_REVISION', 'RESUBMITTED', 'APPROVED', 'CANCELED');

-- CreateEnum
CREATE TYPE "EnrollmentOrderStatusDecision" AS ENUM ('APPROVED', 'NEEDS_CHANGES', 'REJECTED');
...
CREATE TABLE "EnrollmentOrder" (
    ...
    "enrollmentPrice" DOUBLE PRECISION NOT NULL,
    "paymentMethod" "PaymentMethod" NOT NULL DEFAULT 'MOBILE_PAYMENT',
    "paymentReference" INTEGER NOT NULL,
    "approvedAt" TIMESTAMP(3),
    "studentId" TEXT NOT NULL,
...
-- CreateTable
CREATE TABLE "EnrollmentOrderHistory" (
    "id" TEXT NOT NULL,
    "comment" TEXT NOT NULL,
    "previousStatus" "EnrollmentOrderStatus" NOT NULL,
    "decision" "EnrollmentOrderStatusDecision" NOT NULL,
    "resubmittedAt" TIMESTAMP(3),
    "enrollmentOrderId" TEXT NOT NULL,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,

    CONSTRAINT "EnrollmentOrderHistory_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE UNIQUE INDEX "Tutor_activeSubscriptionId_key" ON "Tutor"("activeSubscriptionId");
...
-- CreateIndex
CREATE INDEX "EnrollmentOrder_studentId_idx" ON "EnrollmentOrder"("studentId");

-- CreateIndex
CREATE UNIQUE INDEX "Enrollment_enrollmentOrderId_key" ON "Enrollment"("enrollmentOrderId");
...
-- AddForeignKey
ALTER TABLE "Tutor" ADD CONSTRAINT "Tutor_activeSubscriptionId_fkey" FOREIGN KEY ("activeSubscriptionId") REFERENCES "Subscription"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "EnrollmentOrder" ADD CONSTRAINT "EnrollmentOrder_courseId_fkey" FOREIGN KEY ("courseId") REFERENCES "Course"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "EnrollmentOrderHistory" ADD CONSTRAINT "EnrollmentOrderHistory_enrollmentOrderId_fkey" FOREIGN KEY ("enrollmentOrderId") REFERENCES "EnrollmentOrder"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "Enrollment" ADD CONSTRAINT "Enrollment_enrollmentOrderId_fkey" FOREIGN KEY ("enrollmentOrderId") REFERENCES "EnrollmentOrder"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
