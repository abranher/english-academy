...
export function ApprovedEnrollmentOrders({ studentId }: { studentId: string }) {
  const {
    isPending,
    ...
    | []
  >({
    queryKey: ["tutor_enrollment_orders", EnrollmentOrderStatus.APPROVED],
    queryFn: () =>
      getTutorEnrollmentOrdersByStatus(EnrollmentOrderStatus.APPROVED, tutorId),
  });
  ...
  return (
    <>
      <CardHeader>
        <CardTitle>Listado de órdenes de inscripción aprobadas</CardTitle>
        <CardDescription>
