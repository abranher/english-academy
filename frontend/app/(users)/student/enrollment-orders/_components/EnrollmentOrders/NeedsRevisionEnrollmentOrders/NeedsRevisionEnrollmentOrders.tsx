...
export function NeedsRevisionEnrollmentOrders({
  studentId,
}: {
  studentId: string;
}) {
  ...
  return (
    <>
      <CardHeader>
        <CardTitle>
          Listado de órdenes de inscripción que necesitan revisión
        </CardTitle>
        <CardDescription>
          En esta sección encontrarás todas las órdenes de inscripción que
