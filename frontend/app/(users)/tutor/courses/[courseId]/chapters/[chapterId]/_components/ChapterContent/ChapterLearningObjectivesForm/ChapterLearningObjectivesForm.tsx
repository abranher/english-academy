...
export function ChapterLearningObjectivesForm({
  learningObjectives,
}: {
  ...
  const mutation = useMutation({
    mutationFn: (chapter: { learningObjectives: string }) =>
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormDescription>
                    Los objetivos de aprendizaje guían al capítulo y permiten a
                    los estudiantes conocer las habilidades que adquirirán al
                    finalizar.
                  </FormDescription>
                  <FormMessage />
                </FormItem>
