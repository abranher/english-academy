...
export function ResubmittedEnrollmentOrders({ tutorId }: { tutorId: string }) {
  const {
    isPending,
  ...
  return (
    <>
      <CardHeader>
        <CardTitle>Listado de órdenes de inscripción reenviadas</CardTitle>
        <CardDescription>
