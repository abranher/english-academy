...
export function PendingReviewCoursesList() {
  const {
    isPending,
    data: courses,
    isError,
  } = useQuery<Course[] | []>({
    queryKey: ["get_admin_courses_list", CourseReviewStatus.PENDING_REVIEW],
    queryFn: () => getByReviewStatus(CourseReviewStatus.PENDING_REVIEW),
  });
