    ...
    <section className="flex flex-col gap-1">
      {href ? (
        <Link
          ...
          className={cn(
            "group flex items-center cursor-pointer rounded-sm px-3 py-2 text-sm font-medium transition-colors",
        ...
        <button
          ...
          className={cn(
            "group flex items-center w-full cursor-pointer rounded-sm px-3 py-2 text-sm font-medium transition-colors text-left",
            "hover:bg-zinc-100/50 dark:hover:bg-zinc-800/50",
            isActive &&
              "bg-zinc-100 text-zinc-900 border-l-2 border-zinc-400 " +
                "dark:bg-zinc-800/50 dark:text-zinc-50 dark:border-zinc-500",
